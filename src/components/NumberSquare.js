...
function NumberSquare({number, plain, fadein, movedirection, movespeed}){
    let numberclass = 'square number-square noselect visible';
    let plainclass = 'square plain-square invisible';
    if(number === 0){
        plain = true;
    }
    if(plain===true){
        numberclass = 'square number-square noselect invisible';
        plainclass = 'square plain-square visible';
    }

    if(fadein===true){
        numberclass = 'square number-square noselect visible fade-in';
    }
